...
const About = () => {
  ...
  return (
    <>
      <Helmet>
        <title>About KlientsGrowth | B2B Growth & Automation Experts</title>
        <meta name="description" content="Learn about KlientsGrowth's mission to help B2B SaaS companies scale revenue through automation, performance marketing, and transparent operations." />
      </Helmet>
