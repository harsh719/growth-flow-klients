      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <Button asChild size="lg" className="cta-button text-white hover:text-blue-900 text-lg px-8 py-3">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {services.map((service, index) => (
              <Card key={index} className="team-card hover:shadow-lg transition-shadow">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <Card className="team-card shadow-xl">
              ...
              <CardContent className="p-8 text-center">
                ...
                <Button asChild className="w-full cta-button text-white hover:text-blue-900">
                  <Link to="/contact">
          ...
          <div className="space-y-8">
            <div className="flex items-center space-x-6">
              ...
              <div>
                ...
                <p className="text-white">CRM configuration, messaging development, and target list building</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-6">
              ...
              <div>
                ...
                <p className="text-white">Begin outreach campaigns and optimize based on initial response data</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-6">
              ...
              <div>
                ...
                <p className="text-white">Ramp up successful sequences and deliver your guaranteed 32 meetings</p>
              </div>
            </div>
          </div>
        </div>
